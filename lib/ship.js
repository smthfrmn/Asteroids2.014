(function () {
	...
	Ship.prototype.draw = function(ctx){
		...
		if( o === 0){
			this.drawLines(ctx, x - 20, y + 20, x + 20, y + 20);
		} else if (o === 1){
			this.drawLines(ctx, x - 30, y, x, y + 30);
		} else if (o === 2){
			this.drawLines(ctx, x - 20, y - 20, x - 20, y + 20)
		} else if (o === 3){
			this.drawLines(ctx, x, y - 30, x - 30, y)
		} else if (o === 4) {
			this.drawLines(ctx, x - 20, y - 20, x + 20, y - 20)
		} else if (o === 5){
			this.drawLines(ctx, x, y - 30, x + 30, y)
	...
	Ship.prototype.drawLines = function(ctx, x1, y1, x2, y2){
