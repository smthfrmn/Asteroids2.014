(function (){
  ...
  Asteroid.prototype.spawn = function(){
	  ...
	  if(this.radius > 25){
		  ...
		  var babyA = new Asteroids.Asteroid(asteroid.pos, asteroid.game, rad);
		  var babyB = new Asteroids.Asteroid(asteroid.pos, asteroid.game, rad);
		  debugger
		  this.game.addObj(babyA);
		  this.game.addObj(babyB);
	  }	  
  }
